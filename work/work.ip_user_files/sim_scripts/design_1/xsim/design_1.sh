...
#
# Script generated by Vivado on Sat Jun 14 17:26:31 +0200 2025
...
export RDI_DATADIR="F:/vivado/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_27 -L microblaze_v11_0_14 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L lib_pkg_v1_0_4 -L axi_timer_v2_0_35 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/vivado/Vivado/2024.2/data/xsim"
  fi
